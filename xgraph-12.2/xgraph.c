/* $Header: /cvsroot/nsnam/xgraph/xgraph.c,v 1.4 2001/11/15 21:18:33 difa Exp $ */
/*
 ...
 *
 * $Log: xgraph.c,v $
 * Revision 1.4  2001/11/15 21:18:33  difa
 * add error checking code to avoid core dump when the output device is
 * not X Window.
 *
 ...
 */
#ifndef lint
static char rcsid[] = "$Id: xgraph.c,v 1.4 2001/11/15 21:18:33 difa Exp $";
#endif
...
Display *disp = NULL;		/* Open display            */
